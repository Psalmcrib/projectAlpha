import amazonPayImage from "../assets/images/payment/amazonpay.svg";
import americanExpressImage from "../assets/images/payment/american-express.svg";
import mastercardImage from "../assets/images/payment/mastercard.svg";
import paypalImage from "../assets/images/payment/paypal.svg";
import visaImage from "../assets/images/payment/visa.svg";
import appStoreButtonImage from "../assets/images/appbutton/appstore-btn.svg";
import googlePlayButtonImage from "../assets/images/appbutton/googleplay-btn.svg";
            ...
            <div className="col-lg-5 text-lg-start text-center mb-2 mb-lg-0">
              <ul className="list-inline mb-0">
                ...
                <li className="list-inline-item">
                  <a href="#!">
                    <img src={amazonPayImage} alt="Amazon Pay" />
                  </a>
                </li>
                <li className="list-inline-item">
                  <a href="#!">
          ...
          <div className="row align-items-center">
            <div className="col-md-6">
              <span className="small text-muted">
                ...
                by <a href="../codescandy.com/index.html">Codescandy</a>.
              </span>
            </div>
            <div className="col-md-6">
