...
import menuBanner from "../assets/images/banner/menu-banner.jpg";
                ...
                <div className="collapse mt-2" id="collapseExample">
                  <div className="card card-body">
                    <ul className="mb-0 list-unstyled">
                      <li>
                        <a className="dropdown-item" href="../pages/shop-grid">
                          Dairy, Bread & Eggs
                        </a>
                      </li>
                      <li>
                ...
                <ul className="navbar-nav align-items-center ">
                  ...
                  <li className="nav-item dropdown w-100 w-lg-auto">
                    ...
                    <ul className="dropdown-menu">
                      ...
                      <li>
                        <a className="dropdown-item" href="shop-wishlist">
                          Shop Wishlist
                        </a>
                      </li>
                      <li>
                  ...
                  <li className="nav-item dropdown w-100 w-lg-auto dropdown-flyout">
                    ...
                    >
                      <a className="dropdown-item align-items-start" href="#">
                        <div>
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
